...
in Cross-Domain Surveillance Scenarios. [PDF].
...
Fig. 1. Crops from the seven datasets used in UVIB, grouped by acquisition domain.
...
Fig. 2. Examples of the three target tasks in the UVIB.
